...
let parametriaVacia = buildParametriaVacia();
parametriaMOCKS.set('parametriaVacia', parametriaVacia);
function buildProductosVacio() {
    let productos = [];
...
function buildParametriaVacia() {
    let paramVacia = new ParametriaLegajo();
...
let parametriaLegajo1 = buildParametria('72428');
parametriaMOCKS.set('72428', parametriaLegajo1);
function buildParametria(numeroLegajo) {
...
function buildProductosNotebook() {
    let productos = [];
...
function buildProductosCelular() {
    let productos = [];
    let prod1 = new Producto();
    prod1.rama = '7';
...
function buildProductosTecnoPortatil() {
    let productos = [];
    let prod1 = new Producto();
    prod1.rama = '7';
...
//# sourceMappingURL=mocksParametria.js.map